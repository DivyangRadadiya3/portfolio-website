...
export function Footer() {
  return (
    <>
      <footer className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-y-4 gap-x-12 border-t border-blue-gray-50 py-4 px-6 text-center md:justify-between">
        <nav className="flex items-center justify-between w-full">
        </nav>
        <div className="flex items-center justify-between w-full ">
          <Typography color="black" className="font-normal text-xl md:text-2xl lg:text-3xl xl:text-4xl">
            D_Code
          </Typography>
          <div className="flex  items-center justify-between md:justify-start">
            {LINKS.map(({ title, items }) => (
              <ul key={title} className="flex flex-wrap items-center gap-y-2 gap-x-6 md:gap-x-8 lg:gap-x-10 xl:gap-x-12">
                {items.map((link) => (
                  <li key={link.text} >
                    <Typography
                      as="a"
                      href={link.link}
                      color="blue-gray"
                      className="py-1.5 font-normal text-md sm:text-lg md:text-xl lg:text-2xl xl:text-3xl no-underline hover:text-[#255F38]"
                    >
                      {link.text}
                    </Typography>
                  </li>
        ...
        <div className=" flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          ...
          >
            &copy; {currentYear} <a href="https://material-tailwind.com/">D_Code</a>. All
            Rights Reserved.
          </Typography>
          <div className="flex gap-4 text-blue-gray-900 sm:justify-center">
            <Typography as="a" href="#" className="opacity-80 transition-opacity hover:opacity-100" aria-label="Visit Facebook">
            ...
            <Typography as="a" href="#" className="opacity-80 transition-opacity hover:opacity-100" aria-label="Visit Instagram">
              <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path
                  fillRule="evenodd"
            ...
            <Typography as="a" href="#" className="opacity-80 transition-opacity hover:opacity-100" aria-label="Visit Twitter">
              <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
              </svg>
            </Typography>
            <Typography as="a" href="#" className="opacity-80 transition-opacity hover:opacity-100" aria-label="Visit GitHub">
              <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path
                  fillRule="evenodd"
            ...
            <Typography as="a" href="#" className="opacity-80 transition-opacity hover:opacity-100" aria-label="Visit Dribbble">
              <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path
                  fillRule="evenodd"
